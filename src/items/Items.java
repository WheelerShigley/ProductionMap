...
public class Items extends Registered<Item> {
    ...
    public static final Item BIOTITE_DUST = new Item(GREGTECH,"biotite_dust");
    public static final Item CALCITE_DUST = new Item(GREGTECH,"calcite_dust");
    public static final Item CHISELED_SANDSTONE = new Item(VANILLA,"chiseled_sandstone");
    public static final Item CHISELED_STONE_BRICKS = new Item(VANILLA,"chiseled_stone_bricks");
    public static final Item CIRCUIT_BOARD = new Item(GREGTECH,"circuit_board");
    public static final Item CLAY_DUST = new Item(GREGTECH,"clay_dust");
    ...
    public static final Item DIRT = new Item(VANILLA,"dirt");
    ...
    public static final Item LIGHT_CONCRETE = new Item(GREGTECH,"light_concrete");
    ...
    public static final Item MARBLE_DUST = new Item(GREGTECH,"marble_dust");
    public static final Item METAL_MIXTURE_DUST = new Item(GREGTECH,"metal_mixture_dust");
    ...
    public static final Item NETHERRACK = new Item(VANILLA,"netherrack");
    ...
    public static final Item POTASSIUM_FELDSPAR_DUST = new Item(GREGTECH,"potassium_feldspar_dust");
    public static final Item QUARTZ_SAND = new Item(GREGTECH,"quartz_sand");
    public static final Item QUARTZITE_DUST = new Item(GREGTECH,"quartzite_dust");
    ...
    public static final Item SANDSTONE = new Item(VANILLA,"sandstone");
    public static final Item SMALL_PILE_OF_CLAY_DUST = new Item(GREGTECH,"small_pile_of_clay_dust");
    public static final Item SMALL_PILE_OF_STEEL_DUST = new Item(GREGTECH,"small_pile_of_steel_dust");
    public static final Item SMOOTH_SANDSTONE = new Item(VANILLA,"smooth_sandstone");
    public static final Item SODALITE_DUST = new Item(GREGTECH,"sodalite_dust");
    ...
    public static final Item STONE = new Item(VANILLA,"stone");
    public static final Item STONE_DUST = new Item(GREGTECH,"stone_dust");
    public static final Item SUGAR_CANE = new Item(VANILLA,"sugar_cane");
    public static final Item VACUUM_TUBE = new Item(GREGTECH,"vacuum_tube");
    public static final Item WATER = new Item(GREGTECH,"water");
    public static final Item WET_CONCRETE = new Item(GREGTECH,"wet_concrete");
